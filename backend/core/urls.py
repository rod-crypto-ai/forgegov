...
from .views import (
    ...
    integration_status,
    live_web_status_view,
    live_web_search_view,
    ...
    user_preferences,
    add_opportunity_to_pipeline, pipeline_status,
    ai_chat,
    pipeline_to_pursuit,
    create_saved_search,
    ...
    opportunity_capture_copilot,
    opportunity_competitive_positioning,
    ...
    opportunity_proposal_production,
    proposal_section_detail,
    proposal_section_draft,
    proposal_section_revisions,
    proposal_package_validation,
    proposal_review_center,
    proposal_revision_compare,
    proposal_finding_comments,
...
urlpatterns = [
    ...
    path("settings/preferences/", user_preferences),
    ...
    path("workflow/pipeline-status/", pipeline_status),
    ...
    path("ai/opportunities/<str:source_id>/capture-copilot/", opportunity_capture_copilot),
    path("ai/opportunities/<str:source_id>/competitive-positioning/", opportunity_competitive_positioning),
    ...
    path("ai/opportunities/<str:source_id>/proposal-production/", opportunity_proposal_production),
    path("ai/opportunities/<str:source_id>/proposal-sections/<int:section_id>/", proposal_section_detail),
    path("ai/opportunities/<str:source_id>/proposal-sections/<int:section_id>/draft/", proposal_section_draft),
    path("ai/opportunities/<str:source_id>/proposal-sections/<int:section_id>/revisions/", proposal_section_revisions),
    path("ai/opportunities/<str:source_id>/proposal-package-validation/", proposal_package_validation),
    path("ai/opportunities/<str:source_id>/proposal-review-center/", proposal_review_center),
    path("ai/opportunities/<str:source_id>/proposal-sections/<int:section_id>/compare/", proposal_revision_compare),
    ...
    path("ai/opportunities/<str:source_id>/proposal-findings/<int:finding_id>/comments/", proposal_finding_comments),
