...
export default function TeamPage(){
 ...
 async function load(){if(!admin)return;try{setMembers(await authFetch("/team/members/"));setInvites(await authFetch("/team/invitations/"));}catch(error){setMessage(error instanceof Error?error.message:"Could not load team");}}
