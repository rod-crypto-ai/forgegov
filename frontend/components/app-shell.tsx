...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  function toggleSidebar(){void updatePreferences({sidebar_collapsed:!collapsed}).catch(()=>{})}
  function toggleGroup(label:string,isExpanded:boolean){if(collapsed){void updatePreferences({sidebar_collapsed:false}).catch(()=>{});setExpanded(c=>({...c,[label]:true}));return;}setExpanded(c=>({...c,[label]:!isExpanded}));}
