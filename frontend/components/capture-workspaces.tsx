...
export function PipelineWorkspace(){
 ...
 async function load(){setLoading(true);try{setRows(normalizeList(await apiGet<Pipeline[]>("/pipeline/?page_size=250")));setError("")}catch(e){setError(e instanceof Error?e.message:"Unable to load pipeline")}finally{setLoading(false)}}
 useEffect(()=>{void load()},[]);
...
export function PursuitsWorkspace(){
 ...
 async function load(){try{setRows(normalizeList(await apiGet<Pursuit[]>("/pursuits/?page_size=250")));setError("")}catch(e){setError(e instanceof Error?e.message:"Unable to load pursuits")}}
 useEffect(()=>{void load()},[]);
...
export function TasksWorkspace(){
 ...
 async function load(){try{setRows(normalizeList(await apiGet<Task[]>("/tasks/?page_size=250")));setError("")}catch(e){setError(e instanceof Error?e.message:"Unable to load tasks")}}
 useEffect(()=>{void load()},[]);
